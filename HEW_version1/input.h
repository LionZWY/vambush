...
// ゲームパッド(PS4コントローラー)
#define BUTTON_UP		0x00000001l			// 方向キー上(.IY<0)// 左スティック
...
#define BUTTON_C		0x00000040l			// Ｃボタン(.rgbButtons[2]&0x80)〇ボタン
...
#define BUTTON_R		0x00000800l			// Ｒボタン(.rgbButtons[7]&0x80)R2
#define BUTTON_START	0x00001000l			// ＳＴＡＲＴボタン(.rgbButtons[8]&0x80)
#define BUTTON_M		0x00002000l			// Ｍボタン(.rgbButtons[9]&0x80)
#define GAMEPADMAX		4					// 同時に接続するジョイパッドの最大数をセット

#define R_BUTTON_UP		0x00010000l			// 方向キー上(.IY<0)// 右スティック
#define R_BUTTON_DOWN	0x00020000l			// 方向キー下(.IY>0)
#define R_BUTTON_LEFT	0x00040000l			// 方向キー左(.IX<0)
#define R_BUTTON_RIGHT	0x00080000l			// 方向キー右(.IX>0)

#define BUTTON_R3		0x001000001			// R3押し込み
